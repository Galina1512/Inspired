  ...
  <footer>
    ...
    <div className={s.category}>
        ...
        <div className="s.social">
            <h2 className={cn(s.title, s.socialTitile)}>Связаться с нами</h2>
        ...
        <div className={s.contacts}>
            ...
            <a className={s.link} href='tel:8 9304902620'>8 930 490 26 20</a>
        </div>
        ...
        <div className={s.development}>
            <ul className={s.developmentList}>
                ...
                <li className={s.developmentItem}>
                    Developer:
                    <a className={s.link} href="https://t.me/Quper">  Maksim Leskin </a>
                </li>
